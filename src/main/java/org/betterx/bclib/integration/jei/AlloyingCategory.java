...
public class AlloyingCategory implements IRecipeCategory<RecipeHolder<AlloyingRecipe>> {
    ...
    public void setRecipe(
        ...
        // AlloyingRecipe.assemble() ignores both arguments, it just copies the output stack. On 26.1+
        // the HolderLookup.Provider parameter is gone from Recipe#assemble entirely.
        ItemStack output = recipe.assemble(new AlloyingRecipeInput(ItemStack.EMPTY), null);
